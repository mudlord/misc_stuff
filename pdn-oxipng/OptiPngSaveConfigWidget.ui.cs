...
namespace ILikePi.FileTypes.OptiPng
{
    internal partial class OptiPngSaveConfigWidget
    {
        ...
        private CheckBox zopfli;
        private CheckBox libdeflater;
        ...
        {
            HeaderLabel2 colorHeader = newHeader(L10nStrings.ColorReduction);
        ...
        {
            HeaderLabel2 compressionHeader = newHeader(L10nStrings.Compression);
           ...
           compressionPanel.Controls.Add(threadLabel, 0, 0);
            ...
            numThreads.ValueChanged += tokenChanged;
            compressionPanel.Controls.Add(numThreads, 0, 1);
            ...
            compressionPanel.Controls.Add(compressionComment, 0,2);
            ...
            compressionPanel.Controls.Add(compression, 0, 3);
            ...
            zopfli = createBaseChkBox();
            zopfli.Text = "Use zopfli compressor";
            zopfli.Margin = firstIndent;
            toolTip.SetToolTip(zopfli, "Use the zopfli compressor. Slower than the default compressor.");
            zopfli.CheckedChanged += tokenChanged;
            main.Controls.Add(zopfli);

            libdeflater = createBaseChkBox();
            libdeflater.Text = "Use the 'libdeflater' compressor";
            libdeflater.Margin = firstIndent;
            toolTip.SetToolTip(libdeflater, "Use the 'libdeflater' compressor. Slower than the default compressor.");
            libdeflater.CheckedChanged += tokenChanged;
            main.Controls.Add(libdeflater);
        }
        ...
        private HeaderLabel2 newHeader(string text)
        {
            return new HeaderLabel2
            {
                Dock = DockStyle.Fill,
                Text = text
            };
